...
load_pattern_from_string(const std::string& pattern_str, int stripe_height)
{
    ...
    while (std::getline(iss, line)) {
        ...
        std::map<std::string, int> material_map = {
            ...
            {"qubit_111011", 15},
            {"qubit_111111", 16},
            {"distillation_000000", 17},
            {"distillation_000100", 18},
            {"distillation_001000", 19},
            {"distillation_001100", 20},
            {"distillation_010000", 21},
            {"distillation_010100", 22},
            {"distillation_011000", 23},
            {"distillation_011100", 24},
            {"distillation_100000", 25},
            {"distillation_100100", 26},
            {"distillation_101000", 27},
            {"distillation_101100", 28},
            {"distillation_110000", 29},
            {"distillation_110100", 30},
            {"distillation_111000", 31},
            {"distillation_111100", 32},
            {"routing_1_000000", 33},
            {"routing_1_000100", 34},
            {"routing_1_001000", 35},
            {"routing_1_001100", 36},
